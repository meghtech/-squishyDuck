				...
				<div class="col-md-12" style="margin-top:30px">
					...
					<div class="card-body">
						<div class="item">
							...
							<?php 
							$seller = \App\Models\Seller::find($v->seller_id);
							 ?>
								<tr class="tableRow margin-bottom-8">
									...
									<a href="{{route('file.shareUser', $v->seller_id)}}" class="button button-sliding-icon ripple-effect padding-0">Details<i class="icon-material-outline-arrow-right-alt"></i></a>
