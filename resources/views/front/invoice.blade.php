...
<head>
	...
	<link rel="stylesheet" href="{{asset('content')}}/css/invoice.css">
</head> 
...
<div id="invoice">
	...
	<div class="row">
		...
		<div class="col-xl-6">	
			...
			<p id="details">
				...
				<strong>Issued:</strong> 20/08/2021 <br>
	...
	<div class="row">
		...
		<div class="col-xl-6">	
			<strong class="margin-bottom-5">Seller</strong>
			<p>
				Hireo Ltd. <br>
		...
		<div class="col-xl-6">	
			<strong class="margin-bottom-5">Buyer</strong>
			<p>
				John Doe <br>
