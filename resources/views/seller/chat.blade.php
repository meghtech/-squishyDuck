...
<!-- Chat Content
	================================================== -->
<div  class="container-fluid full-page-content-inner pt-0 pl-0 pr-0 chat-page" 
style="max-height:100%; max-width:100%; position: fixed;"
    id="sellerChatPage">
    ...
    <section class="col-sm-12 col-md-9 col-lg-9 pr-0 pl-0 bg-white" 
    style="float:right">
        ...
        <div class="container-fluid messages" id="viewMessages">
            <div class="col-sm-12 row m-0 p-3 pl-4" v-for="(message, messageIndex) in messages">
                <div class="user-avatar d-inline m-0 mt-2" :class="{ 'status-online': checkIfOnline(message, 'chat')}">
                    <img src="{{ asset('storage/upload/profile') }}" alt="">
                </div>
        ...
        position: relative; margin-bottom:0;background-color:#f2f2f2;">
            <div class="auto-respond col-1 col-sm-1 mb-0 p-0 text-center auto_res">
                <div class="">
                    <ul>
                        <li>
                            <img class="mt-3" height="25px" src="{{ asset('content/images/autoResponder.svg') }}"
                                alt="Auto respond">
                            <div class='floting_menu'
                            style="z-index:2000">
                                <p class="f_op_name">I'm driving,and I'm 20min from you</p>
                                <p class="f_op_name">I'm driving,and I'm 20min from you</p>
                                <p class="f_op_name">I'm driving,and I'm 20min from you</p>
                                <p class="f_op_name">I'm driving,and I'm 20min from you</p>
