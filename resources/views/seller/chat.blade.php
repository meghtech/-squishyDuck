...
<!-- Chat Content
	...
	<div class="container-fluid full-page-content-inner pt-0 pl-0 pr-0 chat-page" style="max-height:100%; max-width:100%;" id="sellerChatPage">
        ...
        <section class="col-sm-12 col-md-9 col-lg-9 pr-0 pl-0 bg-white sections" style="float:right;overflow:hidden; position:relative;">
                ...
                <div class="row m-0 p-0" style="width:100%; margin-bottom:0;background-color:#f2f2f2; position:relative;">
