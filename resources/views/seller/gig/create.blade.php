							...
							<div class="row">
								...
								<div class="col-xl-12">
									<div class="submit-field">
										<h5>Service Title</h5>
										<input type="text" name="title" class="with-border" value="">
									</div>
								</div>
								...
								<div class="col-xl-4">
									<div class="submit-field">
										<h5>Date line</h5> 
										<input type="number" name="totalDay" class="with-border" value="" id="getNumberMain">
									</div>
								</div>
										...
										<div class="row">
											<div class="col-xl-12">
												<div class="input-with-icon">
													<input name="price" class="with-border" type="text" placeholder="Min" value="">
