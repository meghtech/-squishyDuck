        ...
        <div class="dashboard-content-inner" >
            ...
            <div class="row mb-4 p-0">
                ...
                <h4 class="col-md-5 col-sm-12 text-right pr-2 ml-5">
                    <a href="{{ route('seller.createListing') }}" style="color:gray">Add Something</a>
                </h4>
                <a href="{{ route('seller.createListing') }}">
                    <div class="col-1 p-0 text-center" style="max-height:20px; max-width:20px; border:1px solid #28a745; border-radius:4px;">
