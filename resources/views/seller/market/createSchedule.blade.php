                    ...
                    <div class="col-6 float-left">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="morningTime" aria-label="Default select example">
                                <option selected disabled>Morning Times</option>
                                <option value="1">One</option>
                                <option value="2">Two</option>
                                <option value="3">Three</option>
                            </select>
                            <br>
                            <select name="afternoonTime" class="form-select" aria-label="Default select example">
                                <option selected disabled>Afternoon Times</option>
                                <option value="1">One</option>
                                <option value="2">Two</option>
                                <option value="3">Three</option>
                            </select>
