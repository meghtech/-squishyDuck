    ...
    <div class="dashboard-content-container service" data-simplebar>
        <div class="dashboard-content-inner" >
            ...
            <div class="row mb-4 p-0">
                <h2 class="col-6 text-left">Services</h2>
                <h4 class="col-5 text-right pr-2 ml-5">
                    <a href="{{ route('seller.createService') }}" style="color:gray">New Service</a>
                </h4>
                <div class="col-1 p-0 text-center" style="max-height:20px; max-width:20px; border:1px solid #28a745; border-radius:4px;"><a href="{{ route('seller.createService') }}"><i class="fa fa-plus text-success" style="font-size: 10px; vertical-align: middle; margin-top: -9px; margin-left: -0.5px;"></i></a></div>
            </div>
